...
@Profile("chatdocument")
public class ChatDocument implements CommandLineRunner {
    private final Assistant assistant;

    // Create file application-apikey.properties in resources directory and run with
    // profile 'apikey'
    public ChatDocument(@Value("${spring.ai.openai.api-key}") String apiKey) {
...
*/
    ...
    public static void main(String[] args) {
        try {
            SpringApplication.run(ChatDocument.class, args);
